...
class SingleStateNet(nn.Module):
    """ This model assumes the two tracks come in as separate LSTM tracks with no cross attention!"""
    def __init__(self, 
        dim = 32,
        transition_dim = 32, 
        horizon = None,
        ...
        # self.lstm_b = EncoderRNN(input_dim=lstm_dim, hidden_dim = lstm_out_dim, num_layers = 1)
        # self.lstm_b.flatten_parameters()
    ...
    def forward(self, 
        ...
        if global_cond is not None:
            ...
            if 'red_start' in global_cond.keys():
                ...
                global_feature = torch.cat([global_cond['red_start'], global_feature], axis=-1)
