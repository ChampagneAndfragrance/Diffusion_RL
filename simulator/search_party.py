...
class SearchParty(MovingObject, DetectionObject):
    ...
    def detect(self, location_object, speed, timestep):
        """
        ...
        """
        return DetectionObject.detect(self, location_object, speed, timestep)
    ...
    def path(self, camera_list=[], camera_avoid_bool=False):
        ...
        super().path(camera_list, camera_avoid_bool, 140, 150)